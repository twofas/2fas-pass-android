...
import com.twofasapp.feature.loginform.ui.modal.UriSettingsModal
...
internal fun UriField(
    ...
    Row(
        ...
        TextField(
            value = loginUri.text,
            onValueChange = { onUriChange(index, loginUri.copy(text = it)) },
    ...
    if (showUriSettingsModal) {
        UriSettingsModal(
            ...
            loginUri = loginUri,
            onSelectMatcher = { onUriChange(index, loginUri.copy(matcher = it)) },
        )
    }
}
...
private fun Preview() {
    PreviewColumn {
        UriField(
            ...
            index = 0,
            loginUri = LoginUri("https://google.com"),
            totalCount = 2,
        )
