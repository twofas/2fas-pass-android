...
@Composable
internal fun SaveDecryptionKitScreen(
    viewModel: SaveDecryptionKitViewModel = koinViewModel(),
) {
    ...
    DecryptionKitScreen(
        ...
        screenHeaderIcon = painterResource(com.twofasapp.feature.decryptionkit.R.drawable.img_decryption_kit_icon),
