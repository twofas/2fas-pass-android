...
object MdtIcons {
    ...
    val PaymentCard @Composable get() = painterResource(R.drawable.ic_payment_card)
    val PaymentCardDate @Composable get() = painterResource(R.drawable.ic_payment_card_date)
    val PaymentCardCode @Composable get() = painterResource(R.drawable.ic_payment_card_code)
